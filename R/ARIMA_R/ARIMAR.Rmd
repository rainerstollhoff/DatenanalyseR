...
Die `xts()` Zeitreihe ist eine Erweiterung der einfachen `ts()`Zeitreihe. Insbesondere ist es möglich, im `xts` Datentyp neben den reinen Daten (Zeitpunkte und Werte) auch Metadaten (z.B. Datenquelle) abzuspeichern.
...
```{r xts-hint-1}
getSymbols(Symbols= "SAP",src="yahoo")
