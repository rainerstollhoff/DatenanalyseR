...
```{r, echo = T}
mpg_reg <- createDummyFeatures(type.convert(mpg_reg),target="cty")
```
...
mpg_bin <- createDummyFeatures(type.convert(mpg_bin),target="class")
...
mpg_mult <- createDummyFeatures(type.convert(mpg_mult),target="class")
```
