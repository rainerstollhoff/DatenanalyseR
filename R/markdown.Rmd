...
R Markdown verfügt über vielfältige Möglichkeiten, um Text zu formatieren und zu strukturieren. Darunter finden sich die meisten regelmäßig verwendeten Formatierungen wie z.B. Überschriften, Listen, etc. Spezielle Formatierungen wie z.B. zweispaltiger Textsatz oder spezielle Zeilenabstände sind nicht möglich.
...
Um die weitergehende Strukturierung und Formatierung des Textes zu kennzeichnen, verwendet die R Markdown Syntax Sonderzeichen.
...
Eine Überschrift der ersten Ebene lässt sich mit dem Rautezeichen `#` erstellen. Eine Überschrift der zweiten Ebene mit zwei Rautezeichen `##`. Im Folgenden eine Überschrift der vierten Ebene mit vier Rautezeichen `#### Vierte Gliederungsebene`.
...
#### Graphiken
Eine Graphik lässt sich ähnlich wie ein Link einbetten durch ein zusätzliches vorangestelltes Ausrufungszeichen mit
...
Ein Programmcodeblock wird mit dem dreifachen Anführungszeichen eingeleitet. Anschließend folgt in geschweiften Klammern die Angabe der Programmiersprache.
